...
class PartyGroup(CreatedAtMixin, models.Model):
    ...
    creator = models.ForeignKey(User, models.SET_NULL, verbose_name='Создатель', null=True, related_name='party_groups')
    members = models.ManyToManyField(User, verbose_name='Участники', blank=True, related_name='party_members')
...
class PartyPayment(CreatedAtMixin, models.Model):
    ...
    created_at = models.DateTimeField(verbose_name='Дата создания', auto_now_add=True)
    investor = models.ForeignKey(User, models.SET_NULL, verbose_name='Кто платил', null=True,
                                 related_name='party_payments')
